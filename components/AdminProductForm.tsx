...
const schema = z.object({ name: z.string().trim().min(1).max(200), description: z.string().trim().min(1).max(2000), price: z.number().finite().positive(), imageUrl: z.string().url().max(2000) });
